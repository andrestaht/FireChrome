    ...
    */
    public function search_news($string){
        ...
        foreach ($query->result_array() as $row) {
            if (strpos(strtolower($row['title']), strtolower($string)) !== false) { //And is visible ka siia panna?   
        ...
        foreach ($query->result_array() as $row) {
            if (strpos(strtolower($row['content']), strtolower($string)) !== false) { //And is visible ka siia panna? 
